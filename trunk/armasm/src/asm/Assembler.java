...
import asm.instructions.ARM7SingleDataXfer;
import asm.instructions.ARM7B;
import asm.instructions.ParsedInstruction;
...
public class Assembler {
    ...
    private static org.nfunk.jep.JEP myParser = new org.nfunk.jep.JEP();
                ...
                if ( st.hasMoreTokens() ) {
                    ...
                    try {
                        ...
                        while(c > 0) {
                            ...
                            try {
                                instructionHandler = Class.forName("asm.instructions.ARM7" + mneumonic );
                            }
            ...
            while ( e.hasMoreElements() ) {
                ...
                if ( pi.getMneumonic().equals("LTORG") ) {
                    ...
                    if ( pi.getMneumonic().equalsIgnoreCase("DCD") || pi.getMneumonic().equals("&") ) {
                        ...
                        enum.nextElement(); // skip cmd
                        int radix = 10;
                        while ( enum.hasMoreElements() ) {
                            String operand = (String)enum.nextElement();
                            if ( operand.startsWith("$") ) {
                                System.out.print(ia + ": ");
